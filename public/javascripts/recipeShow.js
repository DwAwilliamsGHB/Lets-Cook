...
localStorage.setItem("displayMode", displayModeSelect.value);
}

// Function to set the display mode from local storage
...
localStorage.setItem('currentServings', newServings);
updateIngredientQuantities(); // Update quantities with the new servings
}

function initializeServingsInput() {
const servingsInput = document.getElementById("servings-input");
const savedServings = localStorage.getItem('currentServings'); // Retrieve saved servings from local storage
...
const servingsInput = document.getElementById("servings-input");
const originalServings = servingsInput.getAttribute('data-original-servings');
...
localStorage.setItem('currentServings', originalServings); // Update local storage to the original servings
}
